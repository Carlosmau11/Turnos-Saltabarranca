...
Class Action {
	...
	/********AQUI DECLARO MI FUNCION QUE ME PERMITE CREAR LOS TURNOS Y MOSTRARLO POR ID EN MI
	 * DASHBOARD
	 */
	/***************AQUI CREO MI FUNCION PARA LA NOMENCLATURA DE LOS TURNOS DE PRESIDENCIA */
function save_queue(){
		extract($_POST);
		$data = " name = '$name' ";
		$data .= ", transaction_id = '$transaction_id'";
